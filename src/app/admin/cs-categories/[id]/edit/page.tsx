...
export default function EditCSCategoryPage() {
  const router = useRouter()
  const [isSubmitting, setIsSubmitting] = React.useState(false)
  const [selectedIcon, setSelectedIcon] = React.useState(categoryData.icon)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight lg:text-3xl">CS 카테고리 수정</h1>
          <p className="mt-1 text-muted-foreground">
            "{categoryData.name}" 카테고리를 수정합니다.
          </p>
        </div>
      </div>
              ...
              <CardContent>
                <FieldGroup>
                  ...
                  <Field>
                    ...
                    <Input
                      id="englishName"
                      defaultValue={categoryData.englishName}
                      required
                    />
                  </Field>
